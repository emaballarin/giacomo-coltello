...
fit <- stan(file="./src/normal.stan", data = data, chains = 4, iter=2000);  ##<- ¡¡¡ CAMBIARE file="normal.stan" !!!
...
fit2 <- stan(file="./src/gamma_lambda.stan", data = data, chains = 4, iter=2000, refresh=-1);

...
legend(-1, 3.5, c("Prior", "Analytical posterior", "Stan Posterior"),
       c("dodgerblue", "orange", "darkmagenta" ), cex=0.8)
```

To conclude, we can barely see the difference between the Stan posterior and the analytical one.
